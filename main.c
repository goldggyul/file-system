...
void print_disk(void){
    for(int i=0;i<PARTITION_SIZE;i++){
        printf("%.2x ", *((unsigned char *)disk+i));
    }
}
...
//    // 데이터 넣기
//    for(int i=0;i<size;i++){
//        *((unsigned char*)data_region+dblock*BLOCK_SIZE+i)=fname[0];
//    }
